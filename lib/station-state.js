...
export async function loadStationState({ statePath, defaultState = stationStateDefaults(), normalizers = {} }) {
  ...
  try {
    ...
    throw new Error(`Unable to read station state JSON at ${statePath}: ${error.message}`);
  }
